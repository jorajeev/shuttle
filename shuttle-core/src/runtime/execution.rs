...
use crate::runtime::thread::thread_fn;
use crate::config::{backtrace_enabled, Config, MaxSteps, UNGRACEFUL_SHUTDOWN_CONFIG};
                        ...
                        match e {
                            ...
                            StepError::Deadlock => {
                                ...
                                if !backtrace_enabled() {
                                    eprintln!("Test deadlocked, and {} is not set. If either of those are set then the backtrace of each task will be collected and printed as part of the panic message.", crate::config::CAPTURE_BACKTRACE)
                                }
