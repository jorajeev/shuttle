//! Shuttle's async executor: spawn, JoinHandle, AbortHandle.
//!
//! For `block_on` and `yield_now`, see `shuttle_core::future`.

use shuttle_core::internal::{switch, ExecutionState, TaskId};
use std::error::Error;
